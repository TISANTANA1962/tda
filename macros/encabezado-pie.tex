...
\title{\setulcolor{red}\ul{Apunte Único}: Técnicas de diseño de algoritmos - Práctica \guia} % título
% \author{Por alumnos de TDA\\
\author{\textit{By naD GarRaz}\\
% Facultad de Ciencias Exactas y Naturales \\
% UBA\\
{\tiny última actualización \update}} % autores y lugar
...
%%%% DESCOMENTAR PARA INDICES
\fancyhead[L]{TDA} % encabezado izquierdo
